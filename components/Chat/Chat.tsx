        ...
        <>
          ...
          >
            {selectedConversation?.messages.length === 0 ? (
              ...
              <>
                <div className="sticky top-0 z-10 flex justify-center border border-b-neutral-300 bg-neutral-100 py-2 text-sm text-neutral-500 dark:border-none dark:bg-[#191918] dark:text-neutral-200">
                ...
                <div
                  className="h-[162px] bg-white dark:bg-[#191b1c]"
                  ref={messagesEndRef}
                />
              </>
            )}
